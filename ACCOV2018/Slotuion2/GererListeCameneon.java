...
public class GererListeCameneon {
     ...
     */
    public void ajouterCameneonClient(Cameneon cameneonClient) {
     ...
     */
    public void supprimerCameneonDeListe(Cameneon cameneon) throws IOException {
     ...
     */
    public synchronized void faireMutation(Cameneon autreCameneon, String Couleur) {
     ...
     * @param couleur La couleur de cameneon
     */
    public void gererMutation(Cameneon cameneon, Cameneon autreCameneon, String couleur) {
